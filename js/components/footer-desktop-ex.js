            ...
            >
              ...
              <div class="flex flex-col mt-8">
                <div class="flex flex-col gap-y-3">
                  <span class="text-slate-800 text-sm sm:text-base font-bold sm:font-medium">وب دیزاینر: شقایق</span>
                  <div class="flex gap-x-2">
                    <span class="text-slate-800 text-sm sm:text-base font-bold sm:font-medium">آدرس لینکدین:</span>
                    <a href="https://www.linkedin.com/in/shaghayegh-safavi-957918203" class="text-slate-800 text-sm sm:text-base font-bold sm:font-medium" dir="rtl">.../linkdin.com</a>
                  </div>
                  <div class=" flex gap-x-2">
                    <span class="text-slate-800 text-sm sm:text-base font-bold sm:font-medium">شماره فکس:</span>
                    <span class="text-slate-800" dir="rtl text-sm sm:text-base font-bold sm:font-medium">81233456789</span>
                  </div>
                </div>
                <hr class="my-5" />
                <div class="flex flex-col gap-y-3 ">
                  <span class="text-slate-800 text-sm sm:text-base font-bold sm:font-medium">وب دولوپر-فرانت‌اند: معصومه </span>
                  <div class="flex gap-x-2">
                    <span class="text-slate-800 text-sm sm:text-base font-bold sm:font-medium">لینک گیتهاب:</span>
                    <a class="text-slate-800 text-sm sm:text-base font-bold sm:font-medium" href="https://github.com/masoumemohebbi">.../github.com</a>
                  </div>
                </div>
              </div>
            </div>
